...
import 'package:dolin_demo_flutter/modules/home/data/model.dart';
import 'package:dolin_demo_flutter/modules/home/data/req.dart';
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  '导演：${subject.directors[0].name} / ${subject.directors[0].nameEn}',
                  style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey,
                      fontWeight: FontWeight.w500),
