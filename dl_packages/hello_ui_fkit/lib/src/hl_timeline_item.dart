/*
 * @Author: shaolin 
 * @Date: 2020-03-03 16:39:47 
 * @Last Modified by: shaolin
 * @Last Modified time: 2020-03-03 16:55:50
 */
import 'package:flutter/material.dart';

/// 实线、虚线
enum HLTimelineType { solid, dot }

class HLTimelineItem extends StatelessWidget {
  const HLTimelineItem(
      {@required this.child,
      Key key,
      this.timeLineType = HLTimelineType.solid,
  ...
  /// 时间轴类型
  final HLTimelineType timeLineType;
