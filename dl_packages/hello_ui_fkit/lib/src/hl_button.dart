...
class HLButton extends StatefulWidget {
  const HLButton(
    this.text, {
  ...
  /// 按钮样式
  final HLButtonStyle buttonStyle;
  ...
  @override
  _HLButtonState createState() => _HLButtonState();
}

class _HLButtonState extends State<HLButton> with ProtectClickItem {
  Color fontColor;
  Color borderColor;
              ...
              Column(
                ...
                children: <Text>[
                  ...
                  Text(widget.subText ?? '',
                    ...
                    .map((text) => Offstage(
                        child: text, offstage: text?.data?.isEmpty ?? true))
                    .toList(),
              )
            ],
          )));
...
/// 主按钮样式
const HLButtonStyle _mainButtonStyle = HLButtonStyle(
  bgColor: HLColors.mainButtonBackgroundNormal,
  pressColor: HLColors.mainButtonBackgroundPress,
  disabledColor: HLColors.mainButtonBackgroundDisabled,
  textColor: HLColors.mainButtonTextNormal,
  pressTextColor: HLColors.mainButtonTextPress,
  disabledTextColor: HLColors.mainButtonTextDisabled,
);

/// 副按钮样式
const HLButtonStyle _subButtonStyle = HLButtonStyle(
    bgColor: HLColors.subButtonBackgroundNormal,
    pressColor: HLColors.subButtonBackgroundPress,
    disabledColor: HLColors.subButtonBackgroundDisabled,
    textColor: HLColors.subButtonTextNormal,
    pressTextColor: HLColors.subButtonTextPress,
    disabledTextColor: HLColors.subButtonTextDisabled,
    borderColor: HLColors.subButtonBorderNormal,
    borderPressColor: HLColors.subButtonBorderPress,
    borderDisableColor: HLColors.subButtonBorderDisabled);

/// 主按钮
class HLMainButton extends HLButton {
  HLMainButton(String text,
...
/// 次按钮
class HLSubButton extends HLButton {
  const HLSubButton(String text,
      {@required VoidCallback onPressed,
      double width,
      double height = 40.0,
      EdgeInsetsGeometry padding,
