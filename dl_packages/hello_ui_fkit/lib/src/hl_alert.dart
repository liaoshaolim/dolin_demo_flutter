/*
 * @Author: shaolin 
 * @Date: 2020-02-24 11:37:18 
 * @Last Modified by: shaolin
 * @Last Modified time: 2020-02-24 18:46:16
 */

import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import '../hello_ui_fkit.dart';
        ...
        child: ClipRRect(
            ...
            child: ConstrainedBox(
                ...
                child: FadeInImage.assetNetwork(
                    fit: BoxFit.fill,
                    placeholder:
                        'packages/hello_ui_fkit/assets/imgs/placeholder_pic.png',
                    image: '$imgUrl'))),
      );
}
          ...
          child: RichText(
            ...
            text: TextSpan(children: [
              ...
              TextSpan(
                ...
                text: '$linkText??' '',
                style: const TextStyle(color: HLColors.brand),
              )
            ]),
          ),
        ),
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: HLMainButton(
                  '$rightButtonText',
                  onPressed: () {
                    onTapRightButton ?? Navigator.pop(context);
                  },
                  height: 40,
                  radius: 4.0,
                ),
